"""Native cognis-connect emit for ratewatch — forward findings to any platform.

Maps ratewatch's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    ratewatch ... --format json | ratewatch-emit --to stix
    ratewatch-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
